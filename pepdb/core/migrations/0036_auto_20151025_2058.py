...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='person',
            name='first_name_en',
            field=models.CharField(max_length=30, null=True, verbose_name="\u0406\u043c'\u044f"),
        ),
        migrations.AddField(
            model_name='person',
            name='first_name_ua',
        ...
        migrations.AddField(
            model_name='person',
            name='last_name_en',
            field=models.CharField(max_length=30, null=True, verbose_name='\u041f\u0440\u0456\u0437\u0432\u0438\u0449\u0435'),
        ),
        migrations.AddField(
            model_name='person',
            name='last_name_ua',
        ...
        migrations.AddField(
            model_name='person',
            name='patronymic_en',
            field=models.CharField(max_length=30, null=True, verbose_name='\u041f\u043e-\u0431\u0430\u0442\u044c\u043a\u043e\u0432\u0456', blank=True),
        ),
        migrations.AddField(
            model_name='person',
            name='patronymic_ua',
