...
class Person2Company(AbstractRelationship):
    _relationships_explained = [
        ugettext_noop("министр"),
        ugettext_noop("заместитель министра"),
        ugettext_noop("губернатор"),
        ugettext_noop("вице-губернатор"),
        ugettext_noop("временно исполняющий обязанности губернатора"),
        ugettext_noop("заместитель губернатора"),
        ugettext_noop("сенатор"),
        ugettext_noop("вице-президент"),
        ugettext_noop("депутат"),
        ugettext_noop("руководитель"),
        ugettext_noop("директор"),
        ugettext_noop("генеральный директор"),
        ugettext_noop("президент"),
        ugettext_noop("председатель правления"),
        ugettext_noop("председатель"),
        ugettext_noop("член совета директоров"),
        ugettext_noop("председатель совета директоров"),
        ugettext_noop("председатель совета"),
        ugettext_noop("секретарь"),
        ugettext_noop("заместитель секретаря"),
        ugettext_noop("член правления"),
        ugettext_noop("судья"),
        ugettext_noop("член"),
        ugettext_noop("прокурор"),
        ugettext_noop("основатель"),
        ugettext_noop("участник"),
        ugettext_noop("бывший основатель"),
        ugettext_noop("бенефициар"),
        ugettext_noop("номинальный владелец"),
        ugettext_noop("номинальный директор"),
        ugettext_noop("клиент"),
        ugettext_noop("клиент банка"),
        ugettext_noop("глава"),
        ugettext_noop("исполнительный директор"),
        ugettext_noop("член совета"),
        ugettext_noop("управляющий"),
        ugettext_noop("акционер"),
        ugettext_noop("заместитель генерального директора"),
        ugettext_noop("аудитор"),
        ugettext_noop("владелец"),
        ugettext_noop("совладелец"),
        ugettext_noop("учредитель"),
        ugettext_noop("соучредитель"),
        ugettext_noop("глава администрации"),
        ugettext_noop("главный врач"),
        ugettext_noop("глава совета"),
        ugettext_noop("главный редактор"),
        ugettext_noop("заместитель председателя"),
        ugettext_noop("заместитель руководителя"),
        ugettext_noop("ректор"),
        ugettext_noop("мэр"),
        ugettext_noop("начальник отдела"),
        ugettext_noop("начальник департамента"),
        ugettext_noop("начальник"),
        ugettext_noop("офицер"),
        ugettext_noop("помощник депутата"),
        ugettext_noop("помощник президента"),
        ugettext_noop("советник председателя"),
        ugettext_noop("сопредседатель"),
        ugettext_noop("сотрудник"),
        ugettext_noop("учитель"),
        ugettext_noop("член генерального совета"),
        ugettext_noop("член коллегии"),
        ugettext_noop("член высшего совета"),
        ugettext_noop("член попечительского совета"),
        ugettext_noop("член президиума"),
    ]
