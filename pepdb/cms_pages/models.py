...
class StaticPage(AbstractJinjaPage, Page):
    ...
    body_en = RichTextField(default="", verbose_name="[EN] Текст сторінки")

    translated_title = TranslatedField(
        **{settings.LANGUAGE_CODE: "title", "en": "title_en"}
    )

    translated_body = TranslatedField(
        **{settings.LANGUAGE_CODE: "body", "en": "body_en"}
    )
...
class LinkFields(models.Model):
    ...
    translated_caption = TranslatedField(
        **{settings.LANGUAGE_CODE: "caption", "en": "caption_en"}
    )
...
class HomePage(AbstractJinjaPage, Page):
    ...
    subtitle = RichTextField(default="", verbose_name="[UA] Текст над пошуком")

    subtitle_en = RichTextField(default="", verbose_name="[EN] Текст над пошуком")

    body = RichTextField(default="", verbose_name="[UA] Текст під пошуком")

    body_en = RichTextField(default="", verbose_name="[EN] Текст під пошуком")

    credits = RichTextField(default="", verbose_name="[UA] Текст під статистикою")

    credits_en = RichTextField(default="", verbose_name="[EN] Текст під статистикою")

    eu_desc = RichTextField(default="", verbose_name="[UA] Текст про EU")

    eu_desc_en = RichTextField(default="", verbose_name="[EN] Текст про EU")

    tr_desc = RichTextField(default="", verbose_name="[UA] Текст про Thomson Reuters")

    tr_desc_en = RichTextField(
        default="", verbose_name="[EN] Текст про Thomson Reuters"
    )

    footer = RichTextField(default="", verbose_name="[UA] Текст внизу кожної сторінки")

    footer_en = RichTextField(
        default="", verbose_name="[EN] Текст внизу кожної сторінки"
    )
    ...
    translated_subtitle = TranslatedField(
        **{settings.LANGUAGE_CODE: "subtitle", "en": "subtitle_en"}
    )
    ...
    translated_credits = TranslatedField(
        **{settings.LANGUAGE_CODE: "credits", "en": "credits_en"}
    )

    translated_tr_desc = TranslatedField(
        **{settings.LANGUAGE_CODE: "tr_desc", "en": "tr_desc_en"}
    )

    translated_eu_desc = TranslatedField(
        **{settings.LANGUAGE_CODE: "eu_desc", "en": "eu_desc_en"}
    )

    translated_footer = TranslatedField(
        **{settings.LANGUAGE_CODE: "footer", "en": "footer_en"}
    )
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        ctx["persons_related"] = Person.objects.exclude(type_of_official=1).count()
        return ctx
